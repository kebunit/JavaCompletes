...
public class CreateImageFromString {
    public static void createBMP(String text) throws IOException {
        //create String object to be converted to image
        String sampleText = text;

        //Image file name
        String fileName = "image_out";
    ...
    public static void main(String[] args) throws IOException {
        CreateImageFromString.createBMP("Sabituddin Bigbang");
    }
